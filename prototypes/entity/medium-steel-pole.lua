data:extend({
    {
        ...
        damaged_trigger_effect = {
            ...
            },
            {
                ...
                probability = 0.58333333333333339,
                repeat_count = 1,
                speed_from_center = 0.02,
                speed_from_center_deviation = 0.01,
                type = "create-particle"
        ...
        dying_explosion = "medium-steel-pole-explosion",
            ...
            layers = {
                {
                    ...
                    draw_as_shadow = true,
                    filename =
                    "__IndustrialRevolution3Assets3__/graphics/entities/machines/power/medium-steel-pole-shadow.png",
                    frame_count = 1,
                    height = 64,
                    line_length = 1,
                    priority = "high",
                ...
                },
                {
                    ...
                    filename =
                    "__IndustrialRevolution3Assets3__/graphics/entities/machines/power/medium-steel-pole-base.png",
                    frame_count = 1,
                    height = 256,
                    line_length = 4,
                    priority = "high",
